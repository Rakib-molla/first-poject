      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Add Categories form start -->
            ...
            <?php //categories empty method and add categories 
           ...
           ?>
                    ...
                    <form action="" method="POST">
                        ...
                        <lable for="cat-title"> Add Categories </lable>
                ...
                <div class="col-xl-6">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php   // (Find all categories) show in table
						    ...
						    while ($row = mysqli_fetch_assoc ($select_categories)){
                                ...
                                echo "<tr>";
                                    ...
                                    echo "<td>
                                      <form method='POST'>
                                        <input type='hidden' value={$cat_id} name='delete' />
