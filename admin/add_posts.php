      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li style="margin-top:25px;"> <a href="../index.php"> Back To Home  </a> </li>
            </span>
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Rakib Molla</span>
                <img class="img-profile rounded-circle" src="img/molla.jpg">
              </a>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Welcome To Add Posts </h1>
        ...
        ?>
          ...
          <form action="" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  <lable> Post categories id </lable>
              ...
              <div class="form-group">
                  <lable> Post Image </lable> <br>
                  <input class="" type="file" name="post_image" id="">               
              </div>
              <div class="form-group">
                  <lable> Post content </lable> <br>
                    <textarea name="post_content" id="" cols="100%" rows="5">
                    </textarea>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                  <input class="btn btn-primary" type="button" name="crete_post" type="submit" value="Publish Post">
              </div>
          </form>
